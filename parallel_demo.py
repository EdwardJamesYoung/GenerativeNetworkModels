# -*- coding: utf-8 -*-
"""
Created on Tue Dec  3 13:38:47 2024
...
def run_parallel_models(
    ...
    results_df.to_csv("results_in_mean.csv", index=False)
...
if __name__ == "__main__":    
    ...
    x_values, y_values, z_values = [0], [0], [0]#sample_brain_coordinates(coordinates, [0, 7, 7])
    x_values = [0]
    ...
    eta_values = -np.linspace(2, 4, 3)
    gamma_values = np.linspace(0, .4, 3)
    lambdah_values = [0.0]#np.linspace(0,5,10)
